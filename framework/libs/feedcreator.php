...
该类由VAL/ZYI精简，去除了html,js方法以及save保存文件的方法
同时也修改了默认配置，如默认编码，version显示等
 ...
 * Version string.
 **/
define("FEEDCREATOR_VERSION", "Swan and FeedCreator");
...
class HtmlDescribable {
	 ...
	 */
	var $descriptionHtmlSyndicated=true;
...
class FeedCreator extends HtmlDescribable {
	...
	/**
	* The url of the css stylesheet used to format the naked rss feed.
